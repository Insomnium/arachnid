 ...
 */
public class FSUtil {
    public static FSStorage readStorage(File fileDB) throws IOException, ClassNotFoundException {
        FileInputStream fin = FileUtils.openInputStream(fileDB);
        ObjectInputStream oos = new ObjectInputStream(fin);
        return (FSStorage) oos.readObject();
    }

    public static void saveStorage(FSStorage storage, File fileDB) throws IOException {
